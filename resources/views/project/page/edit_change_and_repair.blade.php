...
<div class="w3-container w3-padding-32" style="padding-left:32px">
  <div class="w3-container w3-padding-16 w3-card-2" style="background-color:#FFFFFF">
    ...
    <div class="w3-container w3-sand w3-leftbar">
      <br>
      <h1 class="w3-center w3-text-indigo">แก้ไขผลการซ่อม</h1>
      <br>
    </div>



@foreach($Eqr as $key => $v) 
    ...
    <div class="w3-content" style="max-width:800px">
      ...
      <p><strong>ห้อง : </strong><i>{{$Eqrr->num_room}}</i></p>
...
@foreach($Eqc as $key => $v) 
    ...
    <div class="w3-content" style="max-width:800px">
      ...
      <p><strong>ห้อง : </strong><i>{{$Eqcc->num_room}}</i></p>
      <p><strong>อุปกรณ์ : </strong><i>{{$v->equiment}}</i></p>
      <p><strong>รายละเอียด : </strong><i>{{$v->detail_equiment}} </i></p>   
      </div>
