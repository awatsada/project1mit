	...
	<div class="w3-container w3-padding-32" style="padding-left:32px">
		<div class="w3-container w3-padding-16 w3-card-2" style="background-color:#FFFFFF">
			<div class="w3-container w3-sand w3-leftbar">
				<br>
				<h1 class="w3-center w3-text-indigo">แก้ไขบันทึกอุปกรณ์สำรอง</h1>
				<br>
			</div>
			<br>
			<div class="w3-content" style="max-width:800px">
				...
				<form class="w3-container" action="{{url('update_stock')}}/{{$Estock->id}}" enctype="multipart/form-data" method="post">								<input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">		
							<div id="itemRows">
								<div class="ui-widget">

									<br>
									ชื่ออุปกรณ์ <input class="w3-input w3-animate-input" id="tags" value="{{$Estock->name}}" name="name0" type="text"  style="width:70%" /></div>
									<br>
									<i> จำนวนอุปกรณ์</i>  
									<input class="w3-input w3-animate-input" value="{{$Estock->number}}" name="num0" type="text"  style="width:70%" />
									<br>
