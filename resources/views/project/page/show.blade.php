...
<div class="w3-main" style="margin-left:250px;">
  ...
  <header class="w3-container w3-theme w3-padding-24" style="padding-left:24px" >
    <h3 class="w3-xxxlarge w3-padding-16">Dormitory Repairing System for PSU</h3>
  </header>
<!-- tab -->
  <style>
    .city {display:none;}
            ...
            <table class="w3-table w3-striped w3-border order-table table">
              <thead>
                ...
                <tr>       
                  ...
                  <td>{{$v->date_repair}}</td>
                  <td>{{$v->time_repair}}</td>
                  <td><a href="{{url('edit_record_complete')}}/{{$v->id}}">
<i class="fa fa-refresh"></i></a></td>
              <td><a href="{{url('delete_record_complete')}}/{{$v->id}}">
          ...
          <div id="Tokyo" class="w3-container city">
            ...
            <table class="w3-table w3-striped w3-border order-table table">
              ...
              <tr>       
                ...
                <td>{{$v->date_repair}}</td>
                <td>{{$v->time_repair}}</td>
                <td><a href="{{url('edit_record_uncomplete')}}/{{$v->id}}">
<i class="fa fa-refresh"></i></a></td>
              <td><a href="{{url('delete_record_uncomplete')}}/{{$v->id}}">
<i class="fa fa-trash"></i></a></td> 
              </tr>
              @endforeach
            </table>
